 ...
 * @author karol
 */
public class Method  implements Serializable{//implementado serializable para trabajar con archivos serializanles
 private ArrayList<Object> lista = new ArrayList<Object>();///variable arrayasListe
    
    public Method(){}//constructor vacio
    
    
    
    public Method(ArrayList<Object> a){//metodo con parametros
        this.lista = a;
    }
    
    /*Este metodo añade a la lista nuestro Objeto beans*/
    public void addRecord(BeansPhysicists p){
        this.lista.add(p);
    }
    ...
    */
    public void modifyRecord(int i, BeansPhysicists p){
        this.lista.set(i, p);
    }
    ...
    */
    public BeansPhysicists getRecord(int i){
        return (BeansPhysicists)lista.get(i);
    }
