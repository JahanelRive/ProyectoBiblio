 ...
 * @author karol
 */
public class LoansOrDevolutions extends javax.swing.JFrame {

    /**
     * Creates new form LoansOrdevolutions
     */
    public LoansOrDevolutions() {
        initComponents();
    }
   ...
   this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoansOrDevolutions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoansOrDevolutions().setVisible(true);
            }
        });
    }
